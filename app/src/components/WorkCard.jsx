  ...
  return (
    ...
    >
      <article className="group flex flex-col aspect-[var(--card-ratio)] items-start relative transition-transform duration-300 ease-out hover:scale-[1.03] motion-reduce:transition-none motion-reduce:transform-none">
        <h2 className="flex h-[50px] items-center gap-2.5 relative font-heading font-semibold text-[var(--color-text-brand-default)] text-[clamp(14px,0.6rem+0.9vw,24px)] tracking-normal leading-[120%] whitespace-nowrap transition-colors duration-300 ease-out group-hover:underline">
          {work.title}
        </h2>
